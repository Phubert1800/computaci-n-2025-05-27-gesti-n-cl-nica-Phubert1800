...
class TestClinica(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Pacientes de prueba
        self.paciente1 = Paciente("Tomas Merino", "12345678", "27/12/1999")
        self.paciente2 = Paciente("Joaquina Hubert", "87654321", "15/01/1990")
        
        # Médicos de prueba
        self.medico1 = Medico("Dr. Francisco Hubert", "1234")
        self.medico1.agregar_especialidad(Especialidad("Pediatría", ["lunes", "miércoles", "viernes"]))
        
        self.medico2 = Medico("Dra. Marcos García", "5678")
    ...
    def test_prevencion_medico_duplicado(self):
        ...
        self.clinica.agregar_medico(self.medico1)
        medico_duplicado = Medico("Dr. Lucas Rodríguez", "1234")
